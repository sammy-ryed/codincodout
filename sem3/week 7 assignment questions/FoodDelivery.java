...
public class FoodDelivery {
    public static void main(String[] args) {
        ...
        r.prepareFood();   // PizzaPlace's method executes
        r.estimateTime();

        r = new SushiBar("Tokyo Sushi");
        r.prepareFood();   // SushiBar's method executes
        r.estimateTime();

        // JVM resolves method calls at runtime based on the actual object type (dynamic method dispatch)
    }
}
