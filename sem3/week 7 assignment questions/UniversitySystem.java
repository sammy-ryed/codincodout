...
public class UniversitySystem {
    public static void main(String[] args) {
        Student s = new Student("Alice", 20, "alice@srmist.edu.in", "CS2021", "Computer Science");

        // Upcasting: Student reference assigned to Person
        Person p = s;
        p.introduce();
        p.getContactInfo();
        ...
        // Upcasting is safe but restricts access to subclass-specific methods
    }
}
